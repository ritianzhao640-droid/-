 ...
 *    TOKEN_CONTRACT.abi        → 新代币合约完整 ABI
 *
 ...
 *
 * 5. DEFAULT_INVITER           → 新默认邀请人地址
 *
 * 6. INVITE_SHORT_MAP          → 新专属短码映射
 *
 * 7. NETWORK                   → 如需换链，修改 RPC、chainId
 *
 * ═══════════════════════════════════════════════════════════
 */
...
// 1. 代币合约 (BACZ ERC-20)
// 数据来源: 新代币部署输出 / BSCScan 验证
const TOKEN_CONTRACT = {
  name: 'BACZToken',
  address: '0x5F7dc0E34920Aa46ae8c7519a35D9d54A5f57777',
  abi:
[
  {
    "inputs": [
...
// 数据来源: 新金库部署输出 / BSCScan 验证
const VAULT_CONTRACT = {
  name: 'BACZVault',
  address: '0x97C28ef2a1bC30b4418B67dA354015707d20e82D',
  abi:
[
  {
    "inputs": [],
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "uint16",
        "name": "_dailyRankSharePercent",
        "type": "uint16"
      },
      {
        "internalType": "uint16",
        "name": "_weightPoolSharePercent",
        "type": "uint16"
      },
      {
        "internalType": "uint256",
...
// 3. 燃烧合约 (Burn / Distributor)
// 数据来源: 新燃烧合约部署输出 / BSCScan 验证
const BURN_CONTRACT = {
  name: 'BACZBurnDistributor',
  address: '0xaBd5898a81fD48eDBD495895b4a0113455ad825b',
  abi:
[
  {
    "inputs": [
  ...
  },
  {
    ...
    "name": "pendingWeightedBurnReward",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  {
    "inputs": [],
    "name": "totalWeightedRewardClaimed",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  {
    "inputs": [],
    "name": "totalWeightedRewardNotified",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
...
[
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "uint256",
        "name": "pendingMarketing",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "totalDailyNotified",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "totalWeightedNotified",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "totalDailyClaimed",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "totalWeightedClaimed",
        "type": "uint256"
      }
    ],
    "stateMutability": "view",
...
// ==================== 前端可直接读取的常量 ====================
const APP_CONFIG = {
  burnGoal: ethers.utils.parseUnits('1000000000', 18),
  milestoneStep: ethers.utils.parseUnits('10000000', 18),
  decimals: 18,
  l1Rate: 1000,
  l2Rate: 500,
};
